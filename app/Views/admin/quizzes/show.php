...
<div class="mx-auto max-w-7xl">
    <div class="flex flex-wrap items-center justify-between gap-3"><a href="<?= site_url('admin/quizzes') ?>" class="inline-flex items-center gap-2 text-xs font-semibold text-slate-400 transition hover:text-orange-600"><svg class="size-4" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="m15 18-6-6 6-6"/></svg>Kembali ke Daftar Quiz</a><div class="flex flex-wrap items-center gap-2"><a href="<?= site_url('admin/quizzes/' . $quiz['id'] . '/report') ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-xl border border-orange-200 bg-white px-4 py-2.5 text-xs font-bold text-orange-600 transition hover:bg-orange-50"><svg class="size-4" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 19V9m5 10V5m5 14v-7m5 7V3"/></svg>Report Quiz</a><?php if (session('admin_role') !== 'PRESENTER'): ?><a href="<?= site_url('admin/quizzes/' . $quiz['id'] . '/edit') ?>" class="inline-flex items-center gap-2 rounded-xl border border-orange-200 bg-orange-50 px-4 py-2.5 text-xs font-bold text-orange-700 transition hover:bg-orange-100"><svg class="size-4" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L8 18l-4 1 1-4Z"/></svg>Edit Quiz</a><?php endif ?><?php if (session('admin_role') !== 'PRESENTER' && $quiz['status'] === 'ACTIVE'): ?><a href="<?= site_url('admin/sessions/create?quiz_id=' . $quiz['id']) ?>" class="inline-flex items-center gap-2 rounded-xl bg-orange-500 px-4 py-2.5 text-xs font-bold text-white shadow-lg shadow-orange-500/20 transition hover:bg-orange-600"><svg class="size-4" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14"/></svg>Buat Sesi</a><?php endif ?></div></div>
